...
The package supports radical pairs with an arbitrary number of
anisotropic nuclei groups, zero-field splitting, exchange interaction,
and anisotropic *g*-tensors. Both single-core and multi-core execution
modes are available.
